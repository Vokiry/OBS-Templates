...
## Все основные функции так или иначе работают, если что то работает коряво или не работает вовсе - feel welcome обратиться в [#issues](https://github.com/Vokiry/OBS-Templates/issues).
